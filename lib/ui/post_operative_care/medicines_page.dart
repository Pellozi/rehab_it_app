  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: Obx(
          () => ListView(
            children: [
              if (careController.listMedicines.length > 0)
                Container(
                        ...
                        children: <Widget>[
                          Row(
                            children: [
                              if (careController.listMedicines.length > 0)
                                Obx(() => Text(
                                      tpEspecialista(careController.listMedicines[0].tpEspecialista),
                                      style: TextStyle(
                              ...
                              if (careController.listMedicines.length > 0)
                                Obx(() => Text(
                                      careController.listMedicines[0].nomeEspecialista,
                                      style: TextStyle(
                                          color: RehabColors().mainColorHover,
                                          fontSize: 16.w,
                              ...
                              if (careController.listMedicines.length > 0)
                                Obx(() => Text(
                                      dateAsStringLongMonth(
                                          DateTime.parse(careController.listMedicines[0].dtPublicacao)),
                                      style: TextStyle(
                                          color: RehabColors().mainColorHover.withOpacity(0.8),
                                          fontSize: 13.w,
                                          fontWeight: FontWeight.w400),
                          ...
                          if (careController.listMedicines.length > 0)
                            Obx(() => Text(
                                  'Faltam ${DateTime.tryParse(careController.listMedicines[0].dtDuracao).difference(DateTime.tryParse(careController.listMedicines[0].dtPublicacao)).inDays} dias para o fim dos medicamentos',
                                  style: TextStyle(
                                      color: RehabColors().mainColorHover.withOpacity(0.8),
                                      fontSize: 14.w,
                                      fontWeight: FontWeight.w500),
              ...
              ...careController.listMedicines.map((element) => StandardItemForCareWidget(
